...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul>
            <li><i class="fp-ht-bed"></i>Jumlah Lowongan : <?php echo $job->REQ_NO_EMPLOYEES; ?></li>
            <li><i class="fp-ht-food"></i>Gaji : <?php echo number_format($job->SALARIES,2);  ?></li>
            <li><i class="fa fa-sun-"></i>Batas Akhir Pendaftaran : <?php echo $job->DURATION_EMPLOYEMENT; ?></li>
        </ul>
	</div> 
	<div class="col-sm-6">
		<ul> 
...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		...
		<li>Kontak : <?php echo $appl->CONTACTNO;?></li>
...
<p><i class="fa fa-paperclip"></i>  Lampiran File</p>
	<div class="col-sm-12 slider">
		 <h3>Unduh Resume <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div> 
