...
<!--   <div class="login-logo">
  ...
  <div class="login-box-body" style="min-height: 400px;">
    <h1 class="login-box-msg">Login Masadmin</h1>
    <hr/>
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="w-100 row d-flex justify-content-between p-0">
        <!-- <div class="col-xs-8"> -->
  ...
  //it creates a new objects of member
    ...
    if ($res==true) { 
      ...
      // if ($_SESSION['ROLE']=='Administrator' || $_SESSION['ROLE']=='Cashier'){
        ...
        if($_SESSION['ROLE'] == 'COM-AMD') {
          unset( $_SESSION['ROLE'] );
          redirect(web_root."company-admin/index.php");
        } else {
          unset( $_SESSION['ROLE'] );
          redirect(web_root."admin/index.php");
        }
