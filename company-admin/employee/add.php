 ...
 <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header">Tambah Data Pegawai</h2>
                              ...
                              <div class="col-md-8">
                                <div class="input-group">
                                    <span class="input-group-addon"> 
                                     ...
                                     <input class="form-control input-sm date_picker" id="BIRTHDATE" name="BIRTHDATE" placeholder="Tanggal Lahir" type="text"    value="" required  autocomplete="off">
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "Kontak" type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                        ...
                        <!--     <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input type="input" class="form-control input-sm date_picker" id="HIREDDATE" name="EMP_HIREDDATE" placeholder="Hari/Bulan/Tahun"   autocomplete="false"/> 
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="Alamat Email"   autocomplete="false"/> 
                                </div>
                              </div>
                            </div>  
