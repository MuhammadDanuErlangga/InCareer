...
switch ($action) {
	...
	function doInsert(){
		...
		if ( $_POST['FNAME'] == "" OR $_POST['LNAME'] == ""
			...
			OR $_POST['TELNO'] == "") {
			$messageStats = false;
			message("Semua form yang diperlukan!","error");
			...
			redirect("index.php?view=add");
				...
				if ($maxrow > 0) { 
					...
					message("Karyawan baru berhasil ditambahkan!", "success");
					redirect("index.php");
			...
			$age = date_diff(date_create($birthdate),date_create('today'))->y;
		 	if ($age < 20 ){
		       ...
		       redirect("index.php?view=edit&id=".$_POST['EMPLOYEEID']);
				...
				message("Data karyawan telah diperbarui!", "success");
	...
	function doDelete(){
		...
		// }
			message("Data karyawan sudah Dihapus!","success");
			redirect('index.php');
		// }
