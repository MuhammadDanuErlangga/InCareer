...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-lg"><b>InCareer</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
                            ...
                            <div class="modal-content">
                                ...
                                "post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        name="savephoto" type="submit">Unggah Foto</button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content-->
                        </div><!-- /.modal-dialog -->
      ...
      <ol class="breadcrumb">
        <?php
          ...
          if ($title!='Home') {
            ...
            echo '<li><a href='.web_root.'admin/><i class="fa fa-dashboard"></i> Beranda</a></li>';
            echo  $active_title;
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="home.php">InCareer</a>.</strong> 
  </footer>
