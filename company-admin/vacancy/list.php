...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Daftar Lowongan  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Tambahkan Lowongan Pekerjaan</a></h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>Status</th> 
				  		 <th width="10%" align="center">Edit/Hapus</th>
				  	</tr>	
				  </thead> 
				  <tbody>
				  	<?php 
				  	 // `COMPANYID`, `OCCUPATIONTITLE`, `REQ_NO_EMPLOYEES`, `SALARIES`, `DURATION_EMPLOYEMENT`, `QUALIFICATION_WORKEXPERIENCE`, `JOBDESCRIPTION`, `PREFEREDSEX`, `SECTOR_VACANCY`, `JOBSTATUS`
						  ...
						  INNER JOIN `tblemployees` e ON c.COMPANYID = e.COMPANYID;
						  ");
