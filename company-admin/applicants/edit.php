                                  ...
                                  <div class="input-group " > 
                                      ...
                                      <i class="fa fa-calendar"></i>  -->
                                        <div class="input-group-addon"> 
                                            ...
                                            <input id="datemask2" name="DATEHIRED"  value="<?php echo date_format(date_create($emp->DATEHIRED),'d/m/Y'); ?>" type="text" class="form-control input-sm datemask2"   data-inputmask="'alias': 'dd/mm/yyyy'" data-mask required>
