...
(8, 'PT Satnetcom Balikpapan', 'Kabupaten Paser, Kalimantan Timur', '(0542) 875570', '', ''),
(9, 'PT. Mitra Insan Sejahtera', 'Kota Mojokerto, Jawa Timur', '0812-1221-2212', '', ''),
(10, 'Teguk Indonesia', 'Kabupaten Tangerang, Banten', ' +6285161726563', '', '');
...
(3, 8, 'Technology', ' Junior Engineer', 1, 4000000, '31 Mei 2024', 'Kami sedang mencari kandidat yang memiliki pemahaman yang kuat tentang sistem TI, baik dalam jaringan komputer kabel maupun nirkabel, serta sistem elektronik dan listrik, yang didukung dengan kemampuan analisis yang baik untuk pemecahan masalah. Kandidat ideal sebaiknya berusia maksimal 30 tahun, fresh graduate dengan gelar Diploma (D3) atau Sarjana (S1) di bidang komputer, atau memiliki latar belakang lulusan Sekolah Menengah Kejuruan (SMK) dengan pengalaman minimal satu tahun pada posisi serupa.', 'Kami sedang mencari Junior Engineer yang dapat bertanggung jawab untuk mendukung pengembangan proyek teknis dengan melakukan pemeliharaan, perbaikan, dan uji coba peralatan, sistem, atau perangkat lunak. ', 'Male/Female', 'Ya', '', '2024-04-30 10:40:00'),
(4, 9, 'Technology', 'IT Programmer (Mojokerto)', 1, 4500000, '15 Mei 2024', 'Kami mencari kandidat yang dapat menunjukkan kemampuan untuk bekerja sama dalam tim, sekaligus memiliki kemampuan untuk bekerja secara mandiri ketika diperlukan. Mereka diharapkan memiliki keterampilan dan keahlian yang relevan dengan bidangnya, serta mampu berkomunikasi secara efektif dengan anggota tim dan pemangku kepentingan lainnya. Kemampuan untuk berkontribusi dalam lingkungan kerja yang kolaboratif, sambil tetap dapat menghasilkan hasil secara mandiri, akan menjadi nilai tambah yang besar bagi peran ini.', 'Kami sedang mencari seorang IT Programmer yang akan menjadi bagian integral dari tim pengembangan perangkat lunak kami, bertanggung jawab untuk merancang, mengembangkan, dan memelihara aplikasi perangkat lunak kami.', 'Male/Female', 'Ya', '', '2024-04-30 10:56:00'),
(5, 10, 'Finance', 'Accounting Ass. Manager', 1, 6000000, '1 Juli 2014', 'Pendidikan S1 Akuntansi/Keuangan/ Management, Memiliki pengalaman minimal 3 tahun sebagai Finance Accounting SPV, Menguasai Microsoft Office dan Software / Program Akuntansi, Memiliki kemampuan analisis data, perencanaan keuangan, dan manajemen risiko', 'Memastikan penyusunan laporan keuangan perusahaan tersedia tepat waktu, Melakukan penyusunan anggaran perusahaan, Mengatur dan memastikan pengelolaan keuangan perusahaan, Menganalisa kinerja keuangan\r\n- AR/AP Management', 'Female', 'Tidak', '', '2024-04-30 11:06:00');
